...
L1TReEmul sequence:  

cms.Schedule(, MEtoEDMConverter, RECOSIMoutput, )
import FWCore.ParameterSet.Config as cms

process = cms.Process("RAW2DIGI")

process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/abrinke1/EMTF/Run2016B/2016_04_29/RAW/ZeroBias1/272012/02BF7BEC-9F0D-E611-90BB-02163E0143F1.root', 
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('output_l1_2016B_mpclct18_nosorting_nosmart_changereadout5to11.root'),
...
process.L1NtupleEMU = cms.Sequence(process.l1CaloTowerEmuTree+process.l1UpgradeEmuTree+process.l1EventTree)
...
process.caloStage2Params = cms.ESProducer("L1TCaloParamsESProducer",
    ...
    etSumEtThreshold = cms.vdouble(0.0, 35.0, 0.0, 35.0),
    ...
    jetCalibrationParams = cms.vdouble(1.52819258712, 0, 1, 0, 1, 
        1, 1.32880934866, 0, 1, 0, 
        1, 1, 1.35650073562, 0, 1, 
        0, 1, 1, 1.55766262213, 0, 
        1, 0, 1, 1, 12.42641269, 
        6.35085569, 1.21845374, -14.70772743, 0.00118945, -10.56931753, 
        12.14768583, 8.05320174, 0.92028575, -15.48969055, 0.00155426, 
        -10.48022143, 11.87301715, 10.45078171, 1.02636603, -16.87586292, 
        0.00210878, -10.34892982, 12.09471152, 9.36873133, 0.96484984, 
        -16.09937338, 0.00177759, -10.43545594, 4.69610083, 11.50217825, 
        1.31071693, -23.88756705, 0.00336036, -19.28130829, 7.08667633, 
        23.68511274, 2.52417732, -43.09154102, 0.00359229, -18.8005501, 
        3.44975454, 28.42124526, 2.58428891, -137.42027137, 0.00669104, 
        -19.53448313, 3.44975454, 28.42124526, 2.58428891, -137.42027137, 
        0.00669104, -19.53448313, 7.08667633, 23.68511274, 2.52417732, 
        -43.09154102, 0.00359229, -18.8005501, 4.69610083, 11.50217825, 
        1.31071693, -23.88756705, 0.00336036, -19.28130829, 12.09471152, 
        9.36873133, 0.96484984, -16.09937338, 0.00177759, -10.43545594, 
        11.87301715, 10.45078171, 1.02636603, -16.87586292, 0.00210878, 
        -10.34892982, 12.14768583, 8.05320174, 0.92028575, -15.48969055, 
        0.00155426, -10.48022143, 12.42641269, 6.35085569, 1.21845374, 
        -14.70772743, 0.00118945, -10.56931753, 1.55766262213, 0, 
        1, 0, 1, 1, 1.35650073562, 
        0, 1, 0, 1, 1, 
        1.32880934866, 0, 1, 0, 1, 
        1, 1.52819258712, 0, 1, 0, 
        1, 1),
    jetCalibrationType = cms.string('function6PtParams22EtaBins'),
    ...
    jetSeedThreshold = cms.double(1.5),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('80X_dataRun2_v8'),
...
process.schedule = cms.Schedule(*[ process.raw2digi_step, process.endjob_step, process.RECOSIMoutput_step, process.L1TReEmulPath, process.l1ntuplesim ])
