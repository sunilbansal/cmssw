void comparison_alct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3_st1_ri3()
{
...
//=========  (Tue May 10 15:28:37 2016) by ROOT version6.06/01
   ...
   c->Range(-10.25806,-3.86129,18.12903,21.88065);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1D *simCscTriggerPrimitiveDigis__57 = new TH1D("simCscTriggerPrimitiveDigis__57","CSCALCTDigi BX ME1/2",22,-6,16);
   simCscTriggerPrimitiveDigis__57->SetBinContent(7,16);
   simCscTriggerPrimitiveDigis__57->SetBinContent(8,16);
   simCscTriggerPrimitiveDigis__57->SetBinContent(9,17);
   simCscTriggerPrimitiveDigis__57->SetBinContent(10,19);
   simCscTriggerPrimitiveDigis__57->SetBinContent(11,9);
   simCscTriggerPrimitiveDigis__57->SetBinContent(12,15);
   simCscTriggerPrimitiveDigis__57->SetBinContent(13,13);
   simCscTriggerPrimitiveDigis__57->SetEntries(105);
   ...
   AText = ptstats->AddText("Entries = 105    ");
   AText = ptstats->AddText("Mean  =  2.819");
   AText = ptstats->AddText("Std Dev   =   1.97");
   ...
   muonCSCDigis__58->SetBinContent(7,16);
   muonCSCDigis__58->SetBinContent(8,16);
   muonCSCDigis__58->SetBinContent(9,17);
   muonCSCDigis__58->SetBinContent(10,19);
   muonCSCDigis__58->SetBinContent(11,9);
   muonCSCDigis__58->SetBinContent(12,15);
   muonCSCDigis__58->SetBinContent(13,13);
   muonCSCDigis__58->SetEntries(105);
