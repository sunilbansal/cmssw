void comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v4_st1_ri3_noBXShift()
{
...
//=========  (Wed May 11 01:08:01 2016) by ROOT version6.06/01
   ...
   TH1D *simCscTriggerPrimitiveDigis__21 = new TH1D("simCscTriggerPrimitiveDigis__21","CSCCorrelatedLCTDigi BX ME1/2",22,-6,16);
   simCscTriggerPrimitiveDigis__21->SetBinContent(12,1);
   simCscTriggerPrimitiveDigis__21->SetBinContent(13,1);
   simCscTriggerPrimitiveDigis__21->SetBinContent(14,2);
   simCscTriggerPrimitiveDigis__21->SetBinContent(15,1);
   simCscTriggerPrimitiveDigis__21->SetBinContent(17,1);
   simCscTriggerPrimitiveDigis__21->SetBinContent(18,2);
   simCscTriggerPrimitiveDigis__21->SetEntries(8);
   ...
   AText = ptstats->AddText("Mean  =  8.125");
   AText = ptstats->AddText("Std Dev   =  2.147");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__22->SetBinContent(12,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__22->SetBinContent(13,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__22->SetBinContent(14,2);
   simCscTriggerPrimitiveDigis_MPCSORTED__22->SetBinContent(15,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__22->SetBinContent(17,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__22->SetBinContent(18,2);
   simCscTriggerPrimitiveDigis_MPCSORTED__22->SetEntries(8);
   ...
   csctfDigis__23->SetBinContent(10,1);
   csctfDigis__23->SetBinContent(11,1);
   csctfDigis__23->SetBinContent(12,2);
   csctfDigis__23->SetBinContent(13,1);
   csctfDigis__23->SetBinContent(15,1);
   csctfDigis__23->SetBinContent(16,2);
   csctfDigis__23->SetEntries(8);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 8      ");
   AText = ptstats->AddText("Mean  =  6.125");
   AText = ptstats->AddText("Std Dev   =  2.147");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   muonCSCDigis__24->SetBinContent(7,3);
   muonCSCDigis__24->SetBinContent(8,5);
   muonCSCDigis__24->SetEntries(8);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 8      ");
   AText = ptstats->AddText("Mean  =  0.625");
   AText = ptstats->AddText("Std Dev   = 0.4841");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__25->SetBinContent(12,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__25->SetBinContent(13,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__25->SetBinContent(14,2);
   simCscTriggerPrimitiveDigis_MPCSORTED__25->SetBinContent(15,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__25->SetBinContent(17,1);
   simCscTriggerPrimitiveDigis_MPCSORTED__25->SetBinContent(18,2);
   simCscTriggerPrimitiveDigis_MPCSORTED__25->SetEntries(8);
