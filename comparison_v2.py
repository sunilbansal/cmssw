...
def compareLCTs(station, ring):
    ...
    tree.Draw(collection + ".obj.data_.second.bx-2>>simCscTriggerPrimitiveDigis",
    ...
    tree.Draw(collection + ".obj.data_.second.bx-2>>simCscTriggerPrimitiveDigis_MPCSORTED",
              collection + ".obj.data_.first.station()==%d && "%(station) + collection + ".obj.data_.first.ring()==%d"%(ring))
    ...
    c.SaveAs("comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3_st%d_ri%d.png"%(station, ring))
    c.SaveAs("comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3_st%d_ri%d.C"%(station, ring))
...
simCscTriggerPrimitiveDigis = TH1D("simCscTriggerPrimitiveDigis","CSCALCTDigi BX; BX; Entries",22,-6,16)
tree.Draw("CSCDetIdCSCALCTDigiMuonDigiCollection_simCscTriggerPrimitiveDigis__RAW2DIGI.obj.data_.second.bx_>>simCscTriggerPrimitiveDigis")
simCscTriggerPrimitiveDigis.SetLineColor(kRed)
simCscTriggerPrimitiveDigis.Draw()
gPad.Update();
...
#c.SaveAs("comparison_alct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v2_clctpretrig2_clcthitpersist6.png")
#c.SaveAs("comparison_alct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v2_clctpretrig2_clcthitpersist6.C")
c.SaveAs("comparison_alct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3.png")
c.SaveAs("comparison_alct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3.C")
...
def compareCLCTs(station, ring):
    ...
    simCscTriggerPrimitiveDigis = TH1D("simCscTriggerPrimitiveDigis","CSCCLCTDigi BX; BX; Entries",22,-6,16)
