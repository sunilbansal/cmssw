...
void CSCMotherboardME11GEM::runNewAlgorithm(const CSCWireDigiCollection* wiredc,
					 const CSCComparatorDigiCollection* compdc,
					 const GEMCSCPadDigiCollection* gemPads)
{
}
...
unsigned int CSCMotherboardME11GEM::findQualityGEM(const CSCCLCTDigi& cLCT, const GEMCSCPadDigi& gem)
{
  return 0;
}
...
void CSCMotherboardME11GEM::retrieveGEMPads(const GEMCSCPadDigiCollection* gemPads, unsigned id, bool iscopad)
{
