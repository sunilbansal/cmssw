void comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v4_st0_ri0_noBXShift()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 11 01:08:00 2016) by ROOT version6.06/01
   TCanvas *c = new TCanvas("c", "c",0,0,800,800);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-10.25806,-128.0323,18.12903,725.5161);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1D *simCscTriggerPrimitiveDigis__1 = new TH1D("simCscTriggerPrimitiveDigis__1","CSCCorrelatedLCTDigi BX All",22,-6,16);
   simCscTriggerPrimitiveDigis__1->SetBinContent(12,485);
   simCscTriggerPrimitiveDigis__1->SetBinContent(13,528);
   simCscTriggerPrimitiveDigis__1->SetBinContent(14,630);
   simCscTriggerPrimitiveDigis__1->SetBinContent(15,616);
   simCscTriggerPrimitiveDigis__1->SetBinContent(16,553);
   simCscTriggerPrimitiveDigis__1->SetBinContent(17,533);
   simCscTriggerPrimitiveDigis__1->SetBinContent(18,468);
   simCscTriggerPrimitiveDigis__1->SetEntries(3813);
   ...
   AText = ptstats->AddText("Entries = 3813   ");
   AText = ptstats->AddText("Mean  =  7.969");
   AText = ptstats->AddText("Std Dev   =  1.916");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(12,485);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(13,528);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(14,630);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(15,616);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(16,553);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(17,533);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(18,468);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetEntries(3813);
   ...
   csctfDigis__3->SetBinContent(10,492);
   csctfDigis__3->SetBinContent(11,532);
   csctfDigis__3->SetBinContent(12,637);
   csctfDigis__3->SetBinContent(13,621);
   csctfDigis__3->SetBinContent(14,561);
   csctfDigis__3->SetBinContent(15,543);
   csctfDigis__3->SetBinContent(16,480);
   csctfDigis__3->SetEntries(3866);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 3866   ");
   AText = ptstats->AddText("Mean  =  5.977");
   ...
   muonCSCDigis__4->SetBinContent(7,1862);
   muonCSCDigis__4->SetBinContent(8,1996);
   muonCSCDigis__4->SetEntries(3858);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 3858   ");
   AText = ptstats->AddText("Mean  = 0.5174");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(12,485);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(13,528);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(14,630);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(15,616);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(16,553);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(17,533);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(18,468);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetEntries(3813);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   AText = pt->AddText("CSCCorrelatedLCTDigi BX All");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
