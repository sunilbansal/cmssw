...
//=========  (Thu May  5 00:54:08 2016) by ROOT version6.06/01
   TCanvas *c = new TCanvas("c", "c",0,0,800,800);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-10.25806,-132.0968,18.12903,748.5484);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__1->SetBinContent(12,558);
   simCscTriggerPrimitiveDigis__1->SetBinContent(13,606);
   simCscTriggerPrimitiveDigis__1->SetBinContent(14,633);
   simCscTriggerPrimitiveDigis__1->SetBinContent(15,645);
   simCscTriggerPrimitiveDigis__1->SetBinContent(16,650);
   simCscTriggerPrimitiveDigis__1->SetBinContent(17,623);
   simCscTriggerPrimitiveDigis__1->SetBinContent(18,233);
   simCscTriggerPrimitiveDigis__1->SetEntries(3948);
   ...
   AText = ptstats->AddText("Entries = 3948   ");
   AText = ptstats->AddText("Mean  =  7.766");
   AText = ptstats->AddText("Std Dev   =  1.822");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(12,558);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(13,606);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(14,633);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(15,645);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(16,650);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetEntries(3092);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 3092   ");
   AText = ptstats->AddText("Mean  =  7.072");
   AText = ptstats->AddText("Std Dev   =  1.401");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   csctfDigis__3->SetBinContent(10,598);
   csctfDigis__3->SetBinContent(11,623);
   csctfDigis__3->SetBinContent(12,629);
   csctfDigis__3->SetBinContent(13,665);
   csctfDigis__3->SetBinContent(14,653);
   csctfDigis__3->SetBinContent(15,624);
   csctfDigis__3->SetBinContent(16,588);
   csctfDigis__3->SetEntries(4380);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 4380   ");
   AText = ptstats->AddText("Mean  =  5.999");
   AText = ptstats->AddText("Std Dev   =  1.967");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   muonCSCDigis__4->SetBinContent(7,2128);
   muonCSCDigis__4->SetBinContent(8,2209);
   muonCSCDigis__4->SetEntries(4337);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 4337   ");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(12,558);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(13,606);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(14,633);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(15,645);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(16,650);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetEntries(3092);
