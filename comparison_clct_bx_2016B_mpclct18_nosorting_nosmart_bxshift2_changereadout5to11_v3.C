void comparison_clct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 10 01:31:43 2016) by ROOT version6.06/01
   TCanvas *c = new TCanvas("c", "c",0,0,800,800);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-10.25806,-1726.81,18.12903,9785.255);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__8->SetBinContent(12,6);
   simCscTriggerPrimitiveDigis__8->SetBinContent(14,8497);
   simCscTriggerPrimitiveDigis__8->SetBinContent(15,17);
   simCscTriggerPrimitiveDigis__8->SetEntries(8520);
   ...
   AText = ptstats->AddText("Entries = 8520   ");
   AText = ptstats->AddText("Mean  =  7.001");
   AText = ptstats->AddText("Std Dev   = 0.06937");
