void comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v4_st2_ri1_noBXShift()
{
...
//=========  (Wed May 11 01:08:01 2016) by ROOT version6.06/01
   ...
   c->Range(-10.25806,-20.52581,18.12903,116.3129);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1D *simCscTriggerPrimitiveDigis__26 = new TH1D("simCscTriggerPrimitiveDigis__26","CSCCorrelatedLCTDigi BX ME2/1",22,-6,16);
   simCscTriggerPrimitiveDigis__26->SetBinContent(12,71);
   simCscTriggerPrimitiveDigis__26->SetBinContent(13,83);
   simCscTriggerPrimitiveDigis__26->SetBinContent(14,97);
   simCscTriggerPrimitiveDigis__26->SetBinContent(15,83);
   simCscTriggerPrimitiveDigis__26->SetBinContent(16,96);
   simCscTriggerPrimitiveDigis__26->SetBinContent(17,101);
   simCscTriggerPrimitiveDigis__26->SetBinContent(18,66);
   simCscTriggerPrimitiveDigis__26->SetEntries(597);
   ...
   AText = ptstats->AddText("Entries = 597    ");
   AText = ptstats->AddText("Mean  =  8.034");
   AText = ptstats->AddText("Std Dev   =  1.903");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetBinContent(12,71);
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetBinContent(13,83);
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetBinContent(14,97);
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetBinContent(15,83);
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetBinContent(16,96);
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetBinContent(17,101);
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetBinContent(18,66);
   simCscTriggerPrimitiveDigis_MPCSORTED__27->SetEntries(597);
   ...
   csctfDigis__28->SetBinContent(10,73);
   csctfDigis__28->SetBinContent(11,83);
   csctfDigis__28->SetBinContent(12,97);
   csctfDigis__28->SetBinContent(13,83);
   csctfDigis__28->SetBinContent(14,96);
   csctfDigis__28->SetBinContent(15,101);
   csctfDigis__28->SetBinContent(16,66);
   csctfDigis__28->SetEntries(599);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 599    ");
   AText = ptstats->AddText("Mean  =  6.023");
   AText = ptstats->AddText("Std Dev   =  1.908");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   muonCSCDigis__29->SetBinContent(7,289);
   muonCSCDigis__29->SetBinContent(8,310);
   muonCSCDigis__29->SetEntries(599);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 599    ");
   AText = ptstats->AddText("Mean  = 0.5175");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetBinContent(12,71);
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetBinContent(13,83);
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetBinContent(14,97);
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetBinContent(15,83);
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetBinContent(16,96);
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetBinContent(17,101);
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetBinContent(18,66);
   simCscTriggerPrimitiveDigis_MPCSORTED__30->SetEntries(597);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   AText = pt->AddText("CSCCorrelatedLCTDigi BX ME2/1");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
