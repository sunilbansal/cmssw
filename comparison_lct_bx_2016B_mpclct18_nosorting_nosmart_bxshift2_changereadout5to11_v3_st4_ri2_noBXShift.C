void comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3_st4_ri2_noBXShift()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 10 15:28:35 2016) by ROOT version6.06/01
   TCanvas *c = new TCanvas("c", "c",0,0,800,800);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-10.25806,-56.7,18.12903,321.3);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1D *simCscTriggerPrimitiveDigis__46 = new TH1D("simCscTriggerPrimitiveDigis__46","CSCCorrelatedLCTDigi BX ME4/2",22,-6,16);
   simCscTriggerPrimitiveDigis__46->SetBinContent(12,172);
   simCscTriggerPrimitiveDigis__46->SetBinContent(13,194);
   simCscTriggerPrimitiveDigis__46->SetBinContent(14,206);
   simCscTriggerPrimitiveDigis__46->SetBinContent(15,251);
   simCscTriggerPrimitiveDigis__46->SetBinContent(16,226);
   simCscTriggerPrimitiveDigis__46->SetBinContent(17,254);
   simCscTriggerPrimitiveDigis__46->SetBinContent(18,279);
   simCscTriggerPrimitiveDigis__46->SetEntries(1582);
   ...
   AText = ptstats->AddText("Entries = 1582   ");
   AText = ptstats->AddText("Mean  =  8.291");
   AText = ptstats->AddText("Std Dev   =  1.971");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetBinContent(12,172);
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetBinContent(13,194);
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetBinContent(14,206);
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetBinContent(15,251);
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetBinContent(16,226);
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetBinContent(17,254);
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetBinContent(18,279);
   simCscTriggerPrimitiveDigis_MPCSORTED__47->SetEntries(1582);
   ...
   csctfDigis__48->SetBinContent(10,172);
   csctfDigis__48->SetBinContent(11,194);
   csctfDigis__48->SetBinContent(12,206);
   csctfDigis__48->SetBinContent(13,251);
   csctfDigis__48->SetBinContent(14,226);
   csctfDigis__48->SetBinContent(15,254);
   csctfDigis__48->SetBinContent(16,279);
   csctfDigis__48->SetEntries(1582);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 1582   ");
   AText = ptstats->AddText("Mean  =  6.291");
   AText = ptstats->AddText("Std Dev   =  1.971");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   muonCSCDigis__49->SetBinContent(7,781);
   muonCSCDigis__49->SetBinContent(8,801);
   muonCSCDigis__49->SetEntries(1582);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 1582   ");
   AText = ptstats->AddText("Mean  = 0.5063");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetBinContent(12,172);
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetBinContent(13,194);
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetBinContent(14,206);
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetBinContent(15,251);
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetBinContent(16,226);
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetBinContent(17,254);
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetBinContent(18,279);
   simCscTriggerPrimitiveDigis_MPCSORTED__50->SetEntries(1582);
