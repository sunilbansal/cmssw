void comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v3_st3_ri1_noBXShift()
{
...
//=========  (Tue May 10 15:28:33 2016) by ROOT version6.06/01
   ...
   c->Range(-10.25806,-108.5226,18.12903,614.9613);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__31->SetBinContent(12,386);
   simCscTriggerPrimitiveDigis__31->SetBinContent(13,427);
   simCscTriggerPrimitiveDigis__31->SetBinContent(14,444);
   simCscTriggerPrimitiveDigis__31->SetBinContent(15,534);
   simCscTriggerPrimitiveDigis__31->SetBinContent(16,465);
   simCscTriggerPrimitiveDigis__31->SetBinContent(17,445);
   simCscTriggerPrimitiveDigis__31->SetBinContent(18,388);
   simCscTriggerPrimitiveDigis__31->SetEntries(3089);
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__32->SetBinContent(12,386);
   simCscTriggerPrimitiveDigis_MPCSORTED__32->SetBinContent(13,427);
   simCscTriggerPrimitiveDigis_MPCSORTED__32->SetBinContent(14,444);
   simCscTriggerPrimitiveDigis_MPCSORTED__32->SetBinContent(15,534);
   simCscTriggerPrimitiveDigis_MPCSORTED__32->SetBinContent(16,465);
   simCscTriggerPrimitiveDigis_MPCSORTED__32->SetBinContent(17,445);
   simCscTriggerPrimitiveDigis_MPCSORTED__32->SetBinContent(18,388);
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__35->SetBinContent(12,386);
   simCscTriggerPrimitiveDigis_MPCSORTED__35->SetBinContent(13,427);
   simCscTriggerPrimitiveDigis_MPCSORTED__35->SetBinContent(14,444);
   simCscTriggerPrimitiveDigis_MPCSORTED__35->SetBinContent(15,534);
   simCscTriggerPrimitiveDigis_MPCSORTED__35->SetBinContent(16,465);
   simCscTriggerPrimitiveDigis_MPCSORTED__35->SetBinContent(17,445);
   simCscTriggerPrimitiveDigis_MPCSORTED__35->SetBinContent(18,388);
