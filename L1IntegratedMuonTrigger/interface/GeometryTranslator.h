...
namespace L1ITMu{
  ...
  public:
    ...
    double calculateGlobalRho(const TriggerPrimitive&) const;
  ...
  private:
    ...
    double calcRPCSpecificRho(const TriggerPrimitive&) const;
    ...
    double calcCSCSpecificRho(const TriggerPrimitive&) const;
    ...
    double calcDTSpecificRho(const TriggerPrimitive&) const;
