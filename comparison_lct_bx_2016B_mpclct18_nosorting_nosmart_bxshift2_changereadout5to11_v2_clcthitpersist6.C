void comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v2_clcthitpersist6()
{
...
//=========  (Sat May  7 09:10:06 2016) by ROOT version6.06/01
   ...
   c->Range(-10.25806,-275.1677,18.12903,1559.284);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__1->SetBinContent(10,1001);
   simCscTriggerPrimitiveDigis__1->SetBinContent(11,1078);
   simCscTriggerPrimitiveDigis__1->SetBinContent(12,1245);
   simCscTriggerPrimitiveDigis__1->SetBinContent(13,1354);
   simCscTriggerPrimitiveDigis__1->SetBinContent(14,1120);
   simCscTriggerPrimitiveDigis__1->SetBinContent(15,1134);
   simCscTriggerPrimitiveDigis__1->SetBinContent(16,953);
   simCscTriggerPrimitiveDigis__1->SetEntries(7885);
   ...
   AText = ptstats->AddText("Entries = 7885   ");
   AText = ptstats->AddText("Mean  =   5.98");
   AText = ptstats->AddText("Std Dev   =  1.911");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(10,1001);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(11,1078);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(12,1245);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(13,1354);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(14,1120);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(15,1134);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(16,953);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetEntries(7885);
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(10,1001);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(11,1078);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(12,1245);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(13,1354);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(14,1120);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(15,1134);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(16,953);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetEntries(7885);
