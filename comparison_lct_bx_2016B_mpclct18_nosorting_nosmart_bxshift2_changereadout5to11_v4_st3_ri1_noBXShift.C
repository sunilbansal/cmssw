void comparison_lct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v4_st3_ri1_noBXShift()
{
...
//=========  (Wed May 11 01:08:02 2016) by ROOT version6.06/01
   ...
   c->Range(-10.25806,-9.348387,18.12903,52.97419);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1D *simCscTriggerPrimitiveDigis__36 = new TH1D("simCscTriggerPrimitiveDigis__36","CSCCorrelatedLCTDigi BX ME3/1",22,-6,16);
   simCscTriggerPrimitiveDigis__36->SetBinContent(12,36);
   simCscTriggerPrimitiveDigis__36->SetBinContent(13,46);
   simCscTriggerPrimitiveDigis__36->SetBinContent(14,41);
   simCscTriggerPrimitiveDigis__36->SetBinContent(15,40);
   simCscTriggerPrimitiveDigis__36->SetBinContent(16,46);
   simCscTriggerPrimitiveDigis__36->SetBinContent(17,44);
   simCscTriggerPrimitiveDigis__36->SetBinContent(18,34);
   simCscTriggerPrimitiveDigis__36->SetEntries(287);
   ...
   AText = ptstats->AddText("Entries = 287    ");
   AText = ptstats->AddText("Mean  =  7.983");
   AText = ptstats->AddText("Std Dev   =  1.937");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetBinContent(12,36);
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetBinContent(13,46);
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetBinContent(14,41);
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetBinContent(15,40);
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetBinContent(16,46);
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetBinContent(17,44);
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetBinContent(18,34);
   simCscTriggerPrimitiveDigis_MPCSORTED__37->SetEntries(287);
   ...
   csctfDigis__38->SetBinContent(10,36);
   csctfDigis__38->SetBinContent(11,46);
   csctfDigis__38->SetBinContent(12,41);
   csctfDigis__38->SetBinContent(13,40);
   csctfDigis__38->SetBinContent(14,46);
   csctfDigis__38->SetBinContent(15,44);
   csctfDigis__38->SetBinContent(16,34);
   csctfDigis__38->SetEntries(287);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 287    ");
   AText = ptstats->AddText("Mean  =  5.983");
   AText = ptstats->AddText("Std Dev   =  1.937");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   muonCSCDigis__39->SetBinContent(7,131);
   muonCSCDigis__39->SetBinContent(8,156);
   muonCSCDigis__39->SetEntries(287);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 287    ");
   AText = ptstats->AddText("Mean  = 0.5436");
   AText = ptstats->AddText("Std Dev   = 0.4981");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetBinContent(12,36);
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetBinContent(13,46);
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetBinContent(14,41);
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetBinContent(15,40);
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetBinContent(16,46);
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetBinContent(17,44);
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetBinContent(18,34);
   simCscTriggerPrimitiveDigis_MPCSORTED__40->SetEntries(287);
