void comparison_lct_bx_2016B_mpclct18_nosorting_bxshift2()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 19:49:33 2016) by ROOT version6.06/01
   TCanvas *c = new TCanvas("c", "c",0,0,800,800);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-10.25806,-271.9161,18.12903,1540.858);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__1->SetBinContent(10,960);
   simCscTriggerPrimitiveDigis__1->SetBinContent(11,1059);
   simCscTriggerPrimitiveDigis__1->SetBinContent(12,1215);
   simCscTriggerPrimitiveDigis__1->SetBinContent(13,1338);
   simCscTriggerPrimitiveDigis__1->SetBinContent(14,1112);
   simCscTriggerPrimitiveDigis__1->SetBinContent(15,1128);
   simCscTriggerPrimitiveDigis__1->SetBinContent(16,402);
   simCscTriggerPrimitiveDigis__1->SetEntries(7214);
   ...
   AText = ptstats->AddText("Entries = 7214   ");
   AText = ptstats->AddText("Mean  =  5.773");
   AText = ptstats->AddText("Std Dev   =  1.784");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(10,960);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(11,1059);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(12,1215);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(13,1338);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(14,1112);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetEntries(5684);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 5684   ");
   AText = ptstats->AddText("Mean  =  5.103");
   AText = ptstats->AddText("Std Dev   =  1.367");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(10,960);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(11,1059);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(12,1215);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(13,1338);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(14,1112);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetEntries(5684);
