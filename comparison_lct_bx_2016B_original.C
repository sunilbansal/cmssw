void comparison_lct_bx_2016B_original()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 20:38:16 2016) by ROOT version6.06/01
   TCanvas *c = new TCanvas("c", "c",0,0,800,800);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-10.25806,-257.0806,18.12903,1456.79);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__1->SetBinContent(12,19);
   simCscTriggerPrimitiveDigis__1->SetBinContent(13,996);
   simCscTriggerPrimitiveDigis__1->SetBinContent(14,1168);
   simCscTriggerPrimitiveDigis__1->SetBinContent(15,1265);
   simCscTriggerPrimitiveDigis__1->SetBinContent(16,55);
   simCscTriggerPrimitiveDigis__1->SetBinContent(17,3);
   simCscTriggerPrimitiveDigis__1->SetEntries(3506);
   ...
   AText = ptstats->AddText("Entries = 3506   ");
   AText = ptstats->AddText("Mean  =    7.1");
   AText = ptstats->AddText("Std Dev   = 0.8527");
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(12,19);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(13,996);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(14,1168);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(15,1264);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetBinContent(16,55);
   simCscTriggerPrimitiveDigis_MPCSORTED__2->SetEntries(3502);
   ...
   AText->SetTextSize(0.046);
   AText = ptstats->AddText("Entries = 3502   ");
   AText = ptstats->AddText("Mean  =  7.097");
   AText = ptstats->AddText("Std Dev   = 0.8488");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(1111);
   ptstats->Draw();
   ...
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(12,19);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(13,996);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(14,1168);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(15,1264);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetBinContent(16,55);
   simCscTriggerPrimitiveDigis_MPCSORTED__5->SetEntries(3502);
