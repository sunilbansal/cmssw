void comparison_clct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v2_clctpretrig2_clcthitpersist6()
{
...
//=========  (Sat May  7 10:11:55 2016) by ROOT version6.06/01
   ...
   c->Range(-10.25806,-1186.635,18.12903,6724.268);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__8->SetBinContent(12,103);
   simCscTriggerPrimitiveDigis__8->SetBinContent(13,2573);
   simCscTriggerPrimitiveDigis__8->SetBinContent(14,5839);
   simCscTriggerPrimitiveDigis__8->SetBinContent(15,1);
   simCscTriggerPrimitiveDigis__8->SetEntries(8516);
   ...
   AText = ptstats->AddText("Entries = 8516   ");
   AText = ptstats->AddText("Mean  =  6.674");
   AText = ptstats->AddText("Std Dev   = 0.4942");
