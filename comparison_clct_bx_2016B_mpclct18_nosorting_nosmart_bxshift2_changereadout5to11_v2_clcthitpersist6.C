void comparison_clct_bx_2016B_mpclct18_nosorting_nosmart_bxshift2_changereadout5to11_v2_clcthitpersist6()
{
...
//=========  (Sat May  7 09:10:06 2016) by ROOT version6.06/01
   ...
   c->Range(-10.25806,-1725.387,18.12903,9777.194);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   simCscTriggerPrimitiveDigis__8->SetBinContent(12,7);
   simCscTriggerPrimitiveDigis__8->SetBinContent(13,5);
   simCscTriggerPrimitiveDigis__8->SetBinContent(14,8490);
   simCscTriggerPrimitiveDigis__8->SetBinContent(15,28);
   simCscTriggerPrimitiveDigis__8->SetEntries(8530);
   ...
   AText = ptstats->AddText("Entries = 8530   ");
   AText = ptstats->AddText("Mean  =  7.001");
   AText = ptstats->AddText("Std Dev   = 0.08456");
